...
a.$ref&&"object"!=typeof a.$ref&&!this.refs[a.$ref]&&(b[a.$ref]=!0);for(var d in a)if(a.hasOwnProperty(d))if(a[d]&&"object"==typeof a[d]&&Array.isArray(a[d]))for(var e=0;e<a[d].length;e++)"object"==typeof a[d][e]&&c(this._getExternalRefs(a[d][e]));else a[d]&&"object"==typeof a[d]&&c(this._getExternalRefs(a[d]));return b},_loadExternalRefs:function(a,b){var c=this,e=this._getExternalRefs(a),f=0,g=0,h=!1;d(e,function(a){
// ignore urls starting with '#'
if("#"!==a.slice(0,1)&&!c.refs[a]){if(!c.options.ajax)throw"Must set ajax option to true to load external ref "+a;c.refs[a]="loading",g++;var d=new XMLHttpRequest,e=a;c.options.nocacherefs&&(e=a+"?rand="+Math.random()),d.open("GET",e,!0),d.onreadystatechange=function(){if(4==d.readyState){
// Request succeeded
if(200!==d.status)throw window.console.log(d),"Failed to fetch ref via ajax- "+a;var e;try{e=JSON.parse(d.responseText)}catch(i){throw window.console.log(i),"Failed to parse external ref "+a}if(!e||"object"!=typeof e)throw"External ref does not contain a valid schema - "+a;c.refs[a]=e,c._loadExternalRefs(e,function(){f++,f>=g&&!h&&(h=!0,b())})}},d.send()}});
// convert from x/y/z to x.y.z
var i=function(a,b){for(var c=a.split("/"),d=b,e=0;e<c.length;e++)if(d.hasOwnProperty(c[e])){if(e===c.length-1)return d[c[e]];d=d[c[e]]}return null};
// for all urls which start with #
// add thier pointers to self.refs now
d(e,function(b){
// use urls starting with '#'
if("#"===b.slice(0,1)){var d=i(b.slice(2),a);d&&(c.refs[b]=d)}}),g||b()},expandRefs:function(a){for(a=c({},a);a.$ref;){var b=a.$ref;delete a.$ref,this.refs[b]||(b=decodeURIComponent(b)),a=this.extendSchemas(a,this.refs[b])}return a},expandSchema:function(a){var b,e=this,f=c({},a);
...
// dynamic hidden
this.schema.hiddenTemplate&&(this.hidden_template=this.jsoneditor.compileTemplate(this.schema.hiddenTemplate,this.template_engine))},addLinks:function(){
// Add links
...
// Layout the form
e=document.createElement("div"),a=0;a<f.length;a++){var i=this.theme.getGridRow();for(e.appendChild(i),b=0;b<f[a].editors.length;b++){var j=f[a].editors[b].key,k=this.editors[j];k.options.hidden&&(k.container.style.display="none"),
//else 
this.theme.setGridColumnSize(k.container,f[a].editors[b].width),i.appendChild(k.container)}}}else e=document.createElement("div"),d(this.property_order,function(a,b){var d=c.editors[b];if(!d.property_removed){var f=c.theme.getGridRow();e.appendChild(f),d.options.hidden&&(d.container.style.display="none"),
//else 
c.theme.setGridColumnSize(d.container,12),f.appendChild(d.container)}});this.row_container.innerHTML="",this.row_container.appendChild(e)}},getPropertySchema:function(a){
